"""#392 V4 annual launch-epoch sweep for the low-amplitude floquet cycler.
...
Usage:
    uv run python scripts/run_392_v4_annual_sweep.py
"""
...
from scripts.run_392_v4_verify import (
    EPHEMERIS,
...
PHASE_LABEL = "392_v4_annual_sweep"
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("data/branch_392_v4_annual_sweep.jsonl"),
    )
