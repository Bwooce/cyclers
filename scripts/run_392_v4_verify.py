"""#392 V4 real-ephemeris (DE440) cross-check for the low-amplitude floquet cycler.
...
Usage:
    uv run python scripts/run_392_v4_verify.py
"""
...
V3_VERDICT_PATH = Path("data/branch_392_v3_verdict.jsonl")
PHASE_LABEL = "392_gauntlet_v4"
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("data/branch_392_v4_verdict.jsonl"),
    )
