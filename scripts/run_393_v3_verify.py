"""#393 V3 REBOUND IAS15 n-body cross-check for the low-amplitude floquet cycler.
...
Usage:
    uv run python scripts/run_393_v3_verify.py
"""
...
V2_VERDICT_PATH = Path("data/branch_393_v2_verdict.jsonl")
PHASE_LABEL = "393_gauntlet_v3"
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("data/branch_393_v3_verdict.jsonl"),
    )
