...
EXPECTED_COVERAGE: dict[ExclusionReason, int] = {
    ...
    # 19 -> 24 (2026-06-30, #494): +5 Ross & Roberts-Tsoukkas 2026 mu-family rows
    ...
    # V_inf at Mars.
    # 15 -> 17 (2026-06-17, #367 wave 2): +2 Case 1 Table 3 circular-
    # coplanar precursor_mga sub-variants (5:4(3)-, 3:2(2)-). Same null
    # V_inf at Mars.
    # 17 -> 19 (2026-06-17, #367 wave 2): +2 Case 2 5:4(3)- and Case 3
    # 3:2(2)- Table 3 circular-coplanar precursor_mga sub-variants. Same
    # null V_inf at Mars.
    # 19 -> 21 (2026-06-17, #367 wave 2): +2 S1L1 5:4(3)- and 3:2(2)-
    # Table 3 circular-coplanar precursor_mga sub-variants. Same null
    # V_inf at Mars.
    # 21 -> 23 (2026-06-17, #367 wave 2): +2 U0L1 4:3(3)- and 2:1(1)-
    # Table 3 circular-coplanar precursor_mga sub-variants. Completes the
    # Rogers 2015 Table 3 admission wave.
