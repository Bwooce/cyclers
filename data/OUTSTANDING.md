...
- **#603** (P2, planning phase first — do NOT build/run yet, review the plan before deciding on
  implementation) — Sun-Neptune transient-capture `quasi_cycler` screen, extending `#535`/`#557`'s
