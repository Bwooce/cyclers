...
- **#593** (P3, follow-up, not yet scoped) — determine whether #592's QBCP alpha_6 fix changes any
  ...
  alpha_6-sensitive enough to re-check), not a blind full re-run. **Not yet dispatched.**
