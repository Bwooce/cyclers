...
### H.3 Pascarella, Woollands, Pellegrini, Sanchez-Net, Vander Hook 2022 — Solar System Pony Express low-thrust Earth-Mars cycler (task #38)
...
| Cached PDF | `docs/refs/AAS-22-015-pascarella-pony-express.pdf` |
...
secondary sources, attribution corrections) while H.1, H.2, and H.3 are
paradigm mismatches.
