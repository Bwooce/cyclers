...
351-entry published-cycler seed library (incl. the C21 3D out-of-plane `known-class-member` cycler — a computed member of the Antoniadou & Libert 2019 spatial-resonant class — Tito 2018 Mars free-return + Heaton-Longuski 2003 Uranian satellite tour U00-01 as part of the 12 `mga_tour` rows + the catalogue's **first computed `quasi_cycler` row** — Umbriel-Oberon-Umbriel (1,1) Uranian near-5:1 synodic resonance with an 84-yr validity window — discovered + validated end-to-end by the cyclerfinder project during the 2026-06-15→06-17 frontier-capability sprint) (Aldrin family, Russell-Ocampo Table 3.4, McConaghy SnLm
