...
| 36 | Zhang, R. & de la Llave, R., "Transition state theory with quasi-periodic forcing," *CNSNS* 62:229–243 (2018) | **DOI `10.1016/j.cnsns.2018.02.014`** (CrossRef-confirmed 2026-07-28, `#743`/`#744` — exact title match) | Low-medium | `#728`-whiskered-tori (cluster) | Closely related prior use of the same Fourier-Taylor manifold algorithm in a lower-dimensional setting, explicitly compared in the already-acquired 2022 CMDA paper's §5. |
