...
- **antoniadou-voyatzis-2013-2-1-resonant-periodic-orbits-3d-planetary-systems-cmda-115-doi-10.1007-s10569-012-9457-4.pdf** | 2026-07-12-digest-antoniadou-voyatzis-2013-2-1-resonant-3d-gtbp.md | General (non-restricted, two-massive-body) spatial 3BP 2/1-resonance periodic-orbit families, stable up to ~50-60° mutual inclination; resolves a dangling "cf. Antoniadou-Voyatzis 2013 Fig. 22" citation in the 2019 Antoniadou-Libert digest but does NOT fix the still-live `known_corpus_3d.py`/`literature_check.py` anchor mislabeling (both cite arXiv:1811.09442 as "Antoniadou-Voyatzis 2018"; that ID is actually Antoniadou & Libert 2019) — flagged as an open corpus-integrity bug, not resolved by this filing | digested | text-layer |
